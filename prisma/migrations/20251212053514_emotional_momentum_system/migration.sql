...
CREATE TABLE "new_RelationshipConfig" (
    ...
    "trustDebt" REAL NOT NULL DEFAULT 0.0,
    "emotionalMomentum" REAL NOT NULL DEFAULT 0.0,
...
INSERT INTO "new_RelationshipConfig" ("affectionPoints", "characterId", "createdAt", "id", "intimacyLevel", "lastActiveAt", "lastStageChangeAt", "messageCount", "specialNotes", "stage", "startDate", "status", "updatedAt", "userId") SELECT "affectionPoints", "characterId", "createdAt", "id", "intimacyLevel", "lastActiveAt", "lastStageChangeAt", "messageCount", "specialNotes", "stage", "startDate", "status", "updatedAt", "userId" FROM "RelationshipConfig";
