...
INSERT INTO "new_RelationshipConfig" ("affectionPoints", "characterId", "createdAt", "id", "intimacyLevel", "lastActiveAt", "messageCount", "specialNotes", "startDate", "status", "updatedAt", "userId") SELECT "affectionPoints", "characterId", "createdAt", "id", "intimacyLevel", "lastActiveAt", "messageCount", "specialNotes", "startDate", "status", "updatedAt", "userId" FROM "RelationshipConfig";
